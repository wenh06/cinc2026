...
# 5-fold CV split shipped with the repo (generated by utils/make_5fold_split.py).
# Structure: {"fold_0": {"train": [...], "val": [...]}, ..., "fold_4": {...}}.
# Fold k is selected at training time via train_config.fold (e.g.
# CINC2026_OVERRIDE_JSON {"fold": 0}) for 5-fold ensemble training.
FIVE_FOLD_SPLIT_FILE = str(Path(PROJECT_DIR) / "utils" / "cinc2026-5fold-split.json")
