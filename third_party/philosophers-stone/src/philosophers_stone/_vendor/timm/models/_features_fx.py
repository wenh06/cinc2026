...
from philosophers_stone._vendor.timm.layers import Conv2dSame, ScaledStdConv2dSame, CondConv2d, StdConv2dSame
from philosophers_stone._vendor.timm.layers.non_local_attn import BilinearAttnTransform
from philosophers_stone._vendor.timm.layers.pool2d_same import MaxPool2dSame, AvgPool2dSame
...
# NOTE: By default, any modules from philosophers_stone._vendor.timm.models.layers that we want to treat as leaf modules go here
# BUT modules from philosophers_stone._vendor.timm.models should use the registration mechanism below
_leaf_modules = {
...
try:
    from philosophers_stone._vendor.timm.layers import InplaceAbn
